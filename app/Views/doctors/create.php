...
<div class="container-fluid px-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            <h2 class="fw-bold text-primary mb-0"><i class="fas fa-user-md me-2"></i>Nuevo Doctor</h2>
            <p class="text-muted mb-0">Registra un nuevo médico en el sistema</p>
        </div>
    </div>
        ...
        <div class="card-body p-4">
            <form action="<?= base_url('doctors/store') ?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" required
                                placeholder="Ej: DOC-009" maxlength="20">
                        </div>
                        <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" maxlength="10" placeholder="10 dígitos">
                        </div>
                        <div class="mb-3">
                            <label for="schedule" class="form-label fw-semibold">Horario de Atención</label>
                            <textarea class="form-control" id="schedule" name="schedule" rows="2"
                                placeholder="Ej: Lunes a Viernes 09:00–17:00"></textarea>
                        </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-5"><i class="fas fa-save me-2"></i>Guardar Doctor</button>
                </div>
            </form>
        </div>
    </div>
