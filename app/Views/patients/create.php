                ...
                <form method="POST" action="<?= base_url('patients/store') ?>">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="username_pac" name="username_pac" class="form-control" required minlength="4" maxlength="100" value="<?= old('username_pac') ?>" placeholder="Ej: juan.perez">
                        </div>
                        <div class="col-md-6">
                            <label for="password_pac" class="form-label">Contraseña (Acceso) <span class="text-danger">*</span></label>
                            <input type="text" id="password_pac" name="password_pac" class="form-control" required minlength="6" value="<?= old('password_pac') ?>" placeholder="Contraseña para el paciente">
                        </div>
                        <div class="col-md-8">
